 ...
 */
public class DictSQLiteOpenHelperOld extends SQLiteOpenHelper {
    private static final String TAG = "DictSQLiteOpenHelperOld";
    ...
    private static DictSQLiteOpenHelperOld helper;

    public static DictSQLiteOpenHelperOld getInstance(Context context) {
        if (helper == null) {
            ...
            helper = new DictSQLiteOpenHelperOld(context.getApplicationContext(), databaseName);
        }
        return helper;
    }
    /**
     ...
     * @param context
     */
    public DictSQLiteOpenHelperOld(Context context, String databaseName) {
        super(context, databaseName, null, DATABASE_VERSION);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        Log.d(TAG, "onCreate DictSQLiteOpenHelperOld...");
        database = db;
